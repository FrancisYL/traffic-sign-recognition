...
def SOLeNet(x, mc, dropout_conv_pct, dropout_fc_pct):
    """
    ...
    print("[SOLeNet] Building neural network [conv layers={0}, conv filter size={1}, conv start depth={2}, fc layers={3}]".format(
